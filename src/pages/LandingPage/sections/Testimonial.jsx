      ...
      <CarouselContent>
        {testimonials.map((testimonial, index) => (
          <CarouselItem key={testimonial.id}>
            <div className="p-1">
              <Card>
                <CardContent className="flex flex-col bg-green-200">
                  <p className="text-md sm:text-2xl md:text-2xl text-gray-900 font-semibold mb-10">&ldquo;{testimonial.review}&rdquo;</p>
                  <div className="flex justify-start">
                    <img className="block sm:w-20 sm:h-20 w-12 h-12 rounded-full" src={testimonial.image} alt="" />
...
const Testimonial = () => {
  return (
    <section class="relative py-20 px-6 lg:pt-10 lg:pb-30 bg-green-200 overflow-hidden">
          ...
          <div class="flex flex-wrap -mx-4 items-center mb-10">
            <div class="w-full px-4 lg:mb-0">
              <span className='text-green-950 md:flex md:mb-6 lg:pt-8 justify-center font-bold text-xl capitalize'>
                ...
                <h1 class="font-heading text-3xl sm:text-4xl xs:text-6xl font-bold text-green-950 mb-4">
                  <span>What our clients</span>
                  <span class="font-serif text-orange-400 italic"> said</span>
                </h1>
                <p class="text-gray-700">We sersve clients from different levels and industries</p>
            </div>
          </div>
